# Agent Lessons and Mistakes Log
...
What went wrong:
Implementation started before reading AGENTS.md and
...
How detected:
The user provided the exact AGENTS.md path.

Correction:
Read both repository agent files before continuing.

Prevention rule:
Always read MEMORY.md, the handoff document, docs/AGENT_LESSONS.md,
and AGENTS.md before project scripts.
